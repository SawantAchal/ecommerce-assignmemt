            ...
            <Transition.Child as={Fragment} enter="transition ease-in-out duration-300 transform" enterFrom="-translate-x-full" enterTo="translate-x-0" leave="transition ease-in-out duration-300 transform" leaveFrom="translate-x-0" leaveTo="-translate-x-full" >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                <div className="flex px-4 pb-2 pt-5">
                  <button type="button" className="relative -m-2 inline-flex items-center justify-center rounded-md p-2 text-gray-400" onClick={() => setOpen(false)} >
            ...
            <div className="flex h-16 items-center px-11">
                                          ...
                                          <ul  role="list"  aria-labelledby={`${section.name}-heading`}  className="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
                                            {section.items.map((item) => (
                                              <li key={item.name} className="flex">
                                                ...
                                                <p onClick={() => handleCategoryClick(category,section,item,close)} className='cursor-pointer hover:to-gray-800'>
                                                  {item.name}
                                                </p>
                                              </li>
                                            ))}
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  ...
                  <Button className='group -m-2 items-center p-2'>
